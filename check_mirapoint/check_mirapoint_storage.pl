...
my $return_code = 0 ;
my $perfparse = "" ;
my $outlabel = "Mirapoint storage ";
my @oids= (".1.3.6.1.4.1.3246.1.1.1.0",".1.3.6.1.4.1.3246.1.1.2.0") ;

$result = $session->get_request(-varbindlist => \@oids) ;
my $percent_used = sprintf("%.2f", $result->{".1.3.6.1.4.1.3246.1.1.2.0"} / $result->{".1.3.6.1.4.1.3246.1.1.1.0"} * 100) ;

$outlabel.="$percent_used% used " ;
$perfparse .= "'$label'=".$result->{".1.3.6.1.4.1.3246.1.1.2.0"}."$unit;" ;
	
if (defined($opt_c) && defined($opt_w)) {
    my $warnused = sprintf("%.0f", $result->{".1.3.6.1.4.1.3246.1.1.1.0"} * $opt_w /100) ;
    my $critused = sprintf("%0.f", $result->{".1.3.6.1.4.1.3246.1.1.1.0"} * $opt_c /100) ;
    if ($percent_used > $opt_w) {
    ...
    $perfparse.="$warnused;$critused;" ;
}else {
    $perfparse.=";;" ;
}

$perfparse .="0;".$result->{".1.3.6.1.4.1.3246.1.1.1.0"} ;
